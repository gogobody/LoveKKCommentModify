...
g.innerHTML+"</p><p>\u6700\u65b0\u7248\u672c\u53f7\uff1a"+a+"</p>":'<h2 class="no-update">\u5f53\u524d\u5df2\u662f\u6700\u65b0\u7248\u672c\uff01</h2><p>\u5f53\u524d\u7248\u672c\u53f7\uff1a'+g.innerHTML+"</p><p>\u6700\u65b0\u7248\u672c\u53f7\uff1a"+a+"</p>"}else d.innerHTML="\u8bf7\u6c42\u5931\u8d25\uff01"};c.open("get","https://api.github.com/repos/gogobody/LoveKKCommentModify/releases/latest",!0);c.send(null)});
